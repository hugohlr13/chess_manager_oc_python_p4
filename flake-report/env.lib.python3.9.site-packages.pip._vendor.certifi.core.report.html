...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.9/site-packages/pip/_vendor/certifi/core.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.9.site-packages.pip._vendor.certifi.core.source.html">
         ...
         <li>
            <a data-code="F811">
               ...
               <strong>F811:</strong> redefinition of unused 'where' from line 23
               
            </a>
            <ul class="details">
            <li>
               
               <a href="env.lib.python3.9.site-packages.pip._vendor.certifi.core.source.html#l34">
                  <tt><i>34</i>     <span class="k">def</span> <span class="nf">where</span><span class="p">():</span></tt>
               </a>
            </li>
            </ul>
         </li>
