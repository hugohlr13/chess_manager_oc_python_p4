...
<html>
   <head>
      <title>flake8 violations: env/lib/python3.9/site-packages/pip/_vendor/pygments/formatters/svg.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.lib.python3.9.site-packages.pip._vendor.pygments.formatters.svg.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.lib.python3.9.site-packages.pip._vendor.pygments.formatters.svg.source.html#l108">
