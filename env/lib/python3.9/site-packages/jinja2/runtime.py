...
class Context:
    ...
    @internalcode
    def call(__self, __obj: t.Callable, *args: t.Any, **kwargs: t.Any) -> t.Union[t.Any, "Undefined"]:  # noqa: B902
...
class AsyncLoopContext(LoopContext):
    ...
    @staticmethod
    def _to_iterator(iterable: t.Union[t.Iterable[V], t.AsyncIterable[V]]) -> t.AsyncIterator[V]:  # type: ignore
