...
from black.lines import (Line, append_leaves, can_be_split,
                         can_omit_invisible_parens, is_line_short_enough,
                         line_to_string)
from black.mode import Feature, Mode, Preview
from black.nodes import (ASSIGNMENTS, CLOSING_BRACKETS, OPENING_BRACKETS,
                         RARROW, STANDALONE_COMMENT, STATEMENT, WHITESPACE,
                         Visitor, ensure_visible, is_arith_like,
                         ...
                         is_rpar_token, is_stub_body, is_stub_suite, is_vararg,
...
def bracket_split_build_line(
    ...
    *,
    ...
    if Preview.handle_trailing_commas_in_head in original.mode and component is _BracketSplitComponent.head:
