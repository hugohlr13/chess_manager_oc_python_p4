...
class _DefaultMixin:
    ...
    def __init__(self, default):
        if isinstance(default, (tuple, list)):
            self.__default__ = tuple((typing._type_check(d, "Default must be a type") for d in default))
        elif default:
...
class TypeVar(typing.TypeVar, _DefaultMixin, _root=True):
    ...
    def __init__(
        self, name, *constraints, bound=None, covariant=False, contravariant=False, default=None, infer_variance=False
    ):
...
if hasattr(typing, "ParamSpec"):
    ...
    class ParamSpec(typing.ParamSpec, _DefaultMixin, _root=True):
        ...
        def __init__(self, name, *, bound=None, covariant=False, contravariant=False, default=None):
            super().__init__(name, bound=bound, covariant=covariant, contravariant=contravariant)
            _DefaultMixin.__init__(self, default)
