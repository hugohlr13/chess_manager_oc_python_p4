...
class Task:
    ...
    _progress: Deque[ProgressSample] = field(default_factory=deque, init=False, repr=False)
...
class Progress(JupyterMixin):
    ...
    def __init__(
        ...
        *columns: Union[str, ProgressColumn],
        ...
        assert refresh_per_second is None or refresh_per_second > 0, "refresh_per_second must be > 0"
        self._lock = RLock()
    ...
    def track(
        ...
        if total is None:
            if isinstance(sequence, Sized):
                ...
                raise ValueError(f"unable to get size of {sequence!r}, please specify 'total'")
        else:
            task_total = total
