...
class ParseLinks(Protocol):
    def __call__(self, page: "HTMLPage", use_deprecated_html5lib: bool) -> Iterable[Link]:
        ...
...
def with_cached_html_pages(fn: ParseLinks) -> ParseLinks:
    ...
    def wrapper(cacheable_page: CacheablePageContent, use_deprecated_html5lib: bool) -> List[Link]:
