...
class BlitzMaxLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"\b(Type|Extends)([ \t]+)(%s)" % (bmax_name), bygroups(Keyword.Reserved, Whitespace, Name.Class)),
            # Keywords
...
class BlitzBasicLexer(RegexLexer):
    ...
    bb_sktypes = r"@{1,2}|[#$%]"
    bb_name = r"[a-z]\w*"
    bb_var = (r"(%s)(?:([ \t]*)(%s)|([ \t]*)([.])([ \t]*)(?:(%s)))?") % (bb_name, bb_sktypes, bb_name)
    ...
    tokens = {
        "root": [
            ...
            # Identifiers
            (r"\b(New)\b([ \t]+)(%s)" % (bb_name), bygroups(Keyword.Reserved, Whitespace, Name.Class)),
            (r"\b(Gosub|Goto)\b([ \t]+)(%s)" % (bb_name), bygroups(Keyword.Reserved, Whitespace, Name.Label)),
            (
            ...
            (r"\b(Type)([ \t]+)(%s)" % (bb_name), bygroups(Keyword.Reserved, Whitespace, Name.Class)),
            # Keywords
...
class QBasicLexer(RegexLexer):
    ...
    tokens = {
        ...
        # XXX: use words() here
        "declarations": [
            (r"\b(%s)(?=\(|\b)" % "|".join(map(re.escape, declarations)), Keyword.Declaration),
        ],
        "functions": [
            (r"\b(%s)(?=\(|\b)" % "|".join(map(re.escape, functions)), Keyword.Reserved),
        ],
        "metacommands": [
            (r"\b(%s)(?=\(|\b)" % "|".join(map(re.escape, metacommands)), Keyword.Constant),
        ],
        "operators": [
