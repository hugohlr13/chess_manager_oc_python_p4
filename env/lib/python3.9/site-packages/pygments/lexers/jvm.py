...
class ScalaLexer(RegexLexer):
    ...
    tokens = {
        ...
        "declarations": [
            (r"\b(def)\b(\s*)%s(%s)?" % (notStartOfComment, anyId), bygroups(Keyword, Whitespace, Name.Function)),
            (r"\b(trait)\b(\s*)%s(%s)?" % (notStartOfComment, anyId), bygroups(Keyword, Whitespace, Name.Class)),
            (
                r"\b(?:(case)(\s+))?(class|object|enum)\b(\s*)%s(%s)?" % (notStartOfComment, anyId),
                bygroups(Keyword, Whitespace, Keyword, Whitespace, Name.Class),
            ),
            (r"(?<!\.)\b(type)\b(\s*)%s(%s)?" % (notStartOfComment, anyId), bygroups(Keyword, Whitespace, Name.Class)),
            ...
            (r"\b(given)\b(\s*)(%s)" % idUpper, bygroups(Keyword, Whitespace, Name.Class)),
            (r"\b(given)\b(\s*)(%s)?" % anyId, bygroups(Keyword, Whitespace, Name)),
        ],
        "inheritance": [
            (
                r"\b(extends|with|derives)\b(\s*)"
                r'(%s|%s|(?=\([^\)]+=>)|(?=%s)|(?="))?' % (idUpper, backQuotedId, plainid),
        ...
        "end": [
            ...
            (r"\b(end)(\s+)(%s)%s" % (idUpper, endOfLineMaybeWithComment), bygroups(Keyword, Whitespace, Name.Class)),
            (
                r"\b(end)(\s+)(%s|%s)?%s" % (backQuotedId, plainid, endOfLineMaybeWithComment),
...
class IokeLexer(RegexLexer):
    ...
    tokens = {
        "interpolatableText": [
            (
                r'(\\b|\\e|\\t|\\n|\\f|\\r|\\"|\\\\|\\#|\\\Z|\\u[0-9a-fA-F]{1,4}' r"|\\[0-3]?[0-7]?[0-7])",
                String.Escape,
            ),
...
class JasminLexer(RegexLexer):
    ...
    tokens = {
        "default": [
            ...
            (r"-?(\d+\.\d*|\.\d+)([eE][-+]?\d+)?[fFdD]?" r"[\x00-\x08\x0b\x0c\x0e-\x1f]*%s" % _break, Number.Float),
            ...
            (r"\.field%s" % _break, Keyword.Reserved, ("descriptor/convert-dots", "field")),
            ...
            (r"(anewarray|checkcast|instanceof|ldc|ldc_w|new)%s" % _break, Keyword.Reserved, "class/no-dots"),
            (
                r"invoke(dynamic|interface|nonvirtual|special|" r"static|virtual)%s" % _break,
                Keyword.Reserved,
                "invocation",
            ),
            (r"(getfield|putfield)%s" % _break, Keyword.Reserved, ("descriptor/no-dots", "field")),
            (r"(getstatic|putstatic)%s" % _break, Keyword.Reserved, ("descriptor/no-dots", "static")),
            (
                words(
                    (
                        "goto",
            ...
            (r"(multianewarray|newarray)%s" % _break, Keyword.Reserved, "descriptor/convert-dots"),
        ...
        "root": [
            ...
            include("default"),
            (r"(%s)([ \t\r]*)(:)" % _name, bygroups(Name.Label, Whitespace, Punctuation)),
            (_name, String.Other),
        ],
        "annotation": [
        ...
        "caught-exception": [(r"all%s" % _break, Keyword, "#pop"), include("exception")],
        "class/convert-dots": [
            include("default"),
            (
            ...
            (r"((?:%s[/.])*)(%s)" % (_unqualified_name, _name), bygroups(Name.Namespace, Name.Class), "#pop"),
        ],
        "class/no-dots": [
            include("default"),
        ...
        "exception": [
            include("default"),
            (r"((?:%s[/.])*)(%s)" % (_unqualified_name, _name), bygroups(Name.Namespace, Name.Exception), "#pop"),
        ],
        "field": [
        ...
        "no-verification": [(r"(locals|method|stack)%s" % _break, Keyword.Reserved, "#pop"), include("default")],
        "static": [
            include("default"),
            (
                r"((?:%s[/.](?=[^%s]*[/.]))*)(%s[/.])?(%s)"
        ...
        "verification": [
            include("default"),
            (r"(Double|Float|Integer|Long|Null|Top|UninitializedThis)%s" % _break, Keyword, "#pop"),
