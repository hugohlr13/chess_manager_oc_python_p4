...
class ElixirLexer(RegexLexer):
    ...
    def gen_elixir_sigil_rules():
        ...
        for term, name in triquotes:
            states["sigils"] += [
                (r"(~[a-z])(%s)" % (term,), bygroups(token, String.Heredoc), (name + "-end", name + "-intp")),
                (r"(~[A-Z])(%s)" % (term,), bygroups(token, String.Heredoc), (name + "-end", name + "-no-intp")),
            ]
    ...
    tokens = {
        "root": [
            ...
            # [keywords: ...]
            (r"(%s|%s)(:)(?=\s|\n)" % (special_atom_re, complex_name_re), bygroups(String.Symbol, Punctuation)),
            # @attributes
