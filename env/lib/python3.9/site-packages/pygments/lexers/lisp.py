...
class RacketLexer(RegexLexer):
    ...
    _inexact_simple = r"(?:%s|(?:\d+#+(?:\.#*|/\d+#*)?|\.\d+#+|" r"\d+(?:\.\d*#+|/\d+#+)))" % _inexact_simple_no_hashes
    ...
    tokens = {
        ...
        "datum": [
            ...
            # #d or no prefix
            (r"(?i)%s[-+]?\d+(?=[%s])" % (_exact_decimal_prefix, _delimiters), Number.Integer, "#pop"),
            (
                r"(?i)%s[-+]?(\d+(\.\d*)?|\.\d+)([deflst][-+]?\d+)?(?=[%s])" % (_exact_decimal_prefix, _delimiters),
                Number.Float,
                "#pop",
            ),
            (
            ...
            (
                ...
                % (_inexact_real, _inexact_unsigned, _inexact_unsigned, _inexact_real, _inexact_real, _delimiters),
                Number.Float,
                "#pop",
            ),
            # The remaining extflonums
            (
                r"(?i)(([-+]?%st[-+]?\d+)|[-+](inf|nan)\.t)(?=[%s])" % (_inexact_simple, _delimiters),
                Number.Float,
                "#pop",
            ),
            # #b
            ...
            (r"'|#[s&]|#hash(eqv?)?|#\d*(?=%s)" % _opening_parenthesis, Operator, ("#pop", "quoted-datum")),
        ],
        ...
        "unquoted-datum": [
            ...
            (r"quasiquote(?=[%s])" % _delimiters, Keyword, ("#pop", "quasiquoted-datum")),
        ...
        "quasiquoted-datum": [
            ...
            (r"unquote(-splicing)?(?=[%s])" % _delimiters, Keyword, ("#pop", "unquoted-datum")),
