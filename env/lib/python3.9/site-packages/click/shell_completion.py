    ...
    def _check_version(self) -> None:
        ...
        if match is not None:
            ...
            if major < "4" or major == "4" and minor < "4":
                raise RuntimeError(_("Shell completion is not supported for Bash" " versions older than 4.4."))
        else:
...
def add_completion_class(cls: t.Type[ShellComplete], name: t.Optional[str] = None) -> None:
...
def _resolve_context(cli: BaseCommand, ctx_args: t.Dict[str, t.Any], prog_name: str, args: t.List[str]) -> Context:
